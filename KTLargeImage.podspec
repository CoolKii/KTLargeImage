...
A tool for loading large images. Reduce memory peaks. Improve loading efficiency and fluency.
  ...
  s.homepage         = 'https://github.com/CoolKii/KTLargeImage'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'CoolKii' => '372160694@qq.com' }
  s.source           = { :git => 'https://github.com/CoolKii/KTLargeImage.git', :tag => s.version.to_s }
